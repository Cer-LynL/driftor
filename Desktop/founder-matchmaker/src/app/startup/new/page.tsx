  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        toast.error(error.error || 'Failed to create startup profile')
      }
    } catch (error) {
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
        <Card>
          <CardHeader>
            <CardTitle>Create Startup Profile</CardTitle>
            <CardDescription>
              Tell us about your startup idea or existing company
            </CardDescription>
          </CardHeader>
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="flex justify-end space-x-4">
                ...
                <Button type="submit" disabled={isLoading}>
                  {isLoading ? 'Creating...' : 'Create Startup Profile'}
                </Button>
              </div>
            </form>
          </CardContent>
